    ...
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1.08fr 0.92fr', gap: 14, marginBottom: 14 }}>
        ...
        <div style={{ background: '#fff', border: bdr, borderRadius: 18, padding: '18px 18px' }}>
          ...
          <MetricBar label="Coherence" value={state.coherence} color="#7F77DD" help="Source-weighted average of all five game pieces." />
          <MetricBar label="Harmony" value={state.harmony} color="#1D9E75" help="How balanced the five bodies are. A weak domain caps advancement." />
        </div>
      </div>
      ...
      <div style={{ background: '#FCFBF8', border: bdr, borderRadius: 16, padding: '15px 16px' }}>
        ...
        <div style={{ fontSize: 13, color: '#555', lineHeight: 1.65 }}>
          The app treats frequency as a gradual climb. A single practice can improve daily signal, but plane advancement requires core energy, clean continuity, Source access, and harmony across all five game pieces. The weakest body caps the climb so the system cannot be gamed by overdeveloping one domain while neglecting another.
        </div>
      </div>
    </div>
  )
