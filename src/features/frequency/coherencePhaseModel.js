...
export function calculateCoherencePhase({
  ...
  const meta = {
    collapse_rebuild: {
      ...
      explanation: 'Today asks for stabilization before expansion. Restore basic movement and reduce overwhelm before adding depth.',
    },
    recovery: {
      ...
      complexity: 'low',
      sourceDirective: 'anchor_source_first',
      explanation: 'Today emphasizes stability before expansion. Lower-friction correction supports recovery without adding strain.',
    },
    stabilization: {
      ...
      complexity: 'standard',
      sourceDirective: 'anchor_source_first',
      explanation: 'Today favors repeatable attunement over aggressive expansion. Stable coherence is the foundation.',
    },
    expansion: {
      ...
      sourceDirective: 'anchor_source_first',
      explanation: 'Enough stability exists to increase depth carefully while preserving Source anchoring.',
    },
    integration: {
      ...
      sourceDirective: 'anchor_source_first',
      explanation: 'A sustained coherence window is open. Today emphasizes integration, maintenance, and clean continuity.',
    },
  }[phase]
