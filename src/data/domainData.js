...
export const DOMAINS = [
  { id: 'd1', name: 'Source', icon: '✦', color: '#7F77DD', bg: '#EEEDFE', text: '#3C3489',
    ...
    questions: [
      ...
      { q: 'How deeply do you sense that you are more than your thoughts, roles, emotions, and personal story?', low: 'I mostly experience myself as my personality, history, and circumstances', high: 'I regularly sense myself as awareness, presence, or Source experiencing through this life', angle: 'Source identity', dimension: 'remembrance' },
      { q: 'When you notice yourself drifting into fear, reaction, or identification, how easily can you return to presence?', low: 'I rarely notice the drift until much later', high: 'I can usually notice the drift and return quickly', angle: 'Return capacity', dimension: 'practice' },
    ] },
  { id: 'd2', name: 'Form', icon: '♥', color: '#1D9E75', bg: '#E1F5EE', text: '#085041',
    ...
    questions: [
      ...
      { q: 'How well do you listen to your body\'s signals before they become exhaustion, tension, illness, or shutdown?', low: 'I usually ignore my body until something forces me to stop', high: 'I notice early signals and adjust before imbalance builds', angle: 'Body listening', dimension: 'embodiment' },
      { q: 'After stress, conflict, or overstimulation, how well does your body return to a calm baseline?', low: 'My body stays activated, tense, or depleted for a long time', high: 'My body usually recovers and settles without much difficulty', angle: 'Nervous system recovery', dimension: 'regulation' },
    ] },
  { id: 'd3', name: 'Field', icon: '∿', color: '#BA7517', bg: '#FAEEDA', text: '#633806',
    ...
    questions: [
      ...
      { q: 'How honest are you with yourself about what you are truly feeling?', low: 'I often minimize, deny, or intellectualize my emotions', high: 'I can usually acknowledge what I feel without judgment', angle: 'Truth recognition', dimension: 'emotional honesty' },
      { q: 'When someone triggers you emotionally, how often can you recognize what belongs to you versus what belongs to them?', low: 'I usually blame, defend, withdraw, or react without seeing my part', high: 'I can usually separate my emotional charge from the actual situation', angle: 'Projection awareness', dimension: 'relational charge' },
    ] },
  { id: 'd4', name: 'Mind', icon: '◈', color: '#378ADD', bg: '#E6F1FB', text: '#0C447C',
    ...
    questions: [
      ...
      { q: 'How well can you question your thoughts instead of automatically believing them?', low: 'My thoughts usually feel true just because they arise', high: 'I can observe, challenge, and redirect thoughts with clarity', angle: 'Thought sovereignty', dimension: 'belief discernment' },
      { q: 'How consistently do your daily choices match what you say matters most to you?', low: 'My actions often contradict my stated priorities', high: 'My choices are usually aligned with my deeper intentions', angle: 'Intentional action', dimension: 'choice alignment' },
    ] },
  { id: 'd5', name: 'Code', icon: '☽', color: '#D85A30', bg: '#FAECE7', text: '#712B13',
    ...
    questions: [
      ...
      { q: 'How clearly can you identify where your recurring patterns likely come from — childhood, protection strategies, fear, unmet needs, or old identity scripts?', low: 'I rarely understand why I repeat certain behaviors', high: 'I can usually trace patterns back to their deeper origin', angle: 'Origin awareness', dimension: 'root pattern recognition' },
      { q: 'When an old pattern appears, how capable are you of choosing a new response before the pattern completes?', low: 'The pattern usually runs all the way through before I realize it', high: 'I can often interrupt the pattern and choose a different response', angle: 'Pattern interruption', dimension: 'rewriting capacity' },
    ] }
]
